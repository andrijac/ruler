...
namespace Ruler
{
    sealed public class MainForm : Form, IRulerInfo
    {
        ...
        private void SetUpMenu()
        {
            ...
            {
                MenuItem Subrotation = new MenuItem(x.ToString());
                Subrotation.Checked =false;
                Subrotation.Click += new EventHandler(HandeRotation);
                rotationMenuItem.MenuItems.Add(Subrotation);
            }
        ...
        private void HandeRotation(object sender, EventArgs e)
        {
            MenuItem me = (MenuItem)sender;
            this.UncheckMenuItem(me.Parent);
            me.Checked = true;
            this.Rotationangle = int.Parse(me.Text);
