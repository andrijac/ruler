...
namespace Ruler
{
    sealed public class MainForm : Form, IRulerInfo
    {
        ...
        private static void Main(params string[] args)
        {
            ...
            if (args.Length == 0)
            {
                RulerInfo ruler = RulerInfo.CheckforSavedSettings();
                if (ruler is default(RulerInfo))
                {
        ...
        private void Init(RulerInfo rulerInfo)
        {
            ...
            this.Location = rulerInfo.FormLocation;
            this.Size = rulerInfo.FormSize;
            // Create menu
        ...
        {
            RulerInfo.SetSavedSettings(this);
            this.Close();
        }
